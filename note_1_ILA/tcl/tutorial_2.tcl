...
set proj_path "."
set ip_path "./ip_repo"
set hls_ip_1 "../scalar_add/solution1/impl/ip/xilinx_com_hls_add_1_0.zip"
set hls_ip_2 "../mult_constant/solution1/impl/ip/xilinx_com_hls_mult_constant_1_0.zip"
set overlay_path "../../overlays"

# Create custom project
create_project $proj_name $proj_path -part xczu7ev-ffvc1156-2-e
set_property BOARD_PART xilinx.com:zcu104:part0:1.1 [current_project]

file mkdir $ip_path
set_property ip_repo_paths $ip_path [current_project]
update_ip_catalog
update_ip_catalog -add_ip $hls_ip_1 -repo_path $ip_path
update_ip_catalog -add_ip $hls_ip_2 -repo_path $ip_path
...
proc create_hier_cell_const_multiply { parentCell nameHier } {
  ...
  set multiply [ create_bd_cell -type ip -vlnv xilinx.com:hls:mult_constant:1.0 multiply ]
  ...
  connect_bd_intf_net -intf_net multiply_B [get_bd_intf_pins multiply/B] [get_bd_intf_pins multiply_dma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net multiply_dma_M_AXIS_MM2S [get_bd_intf_pins multiply/A] [get_bd_intf_pins multiply_dma/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins s_axi_control] [get_bd_intf_pins multiply/s_axi_control]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins multiply_dma/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins multiply/ap_rst_n] [get_bd_pins multiply_dma/axi_resetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_lite_aclk] [get_bd_pins multiply/ap_clk] [get_bd_pins multiply_dma/m_axi_mm2s_aclk] [get_bd_pins multiply_dma/m_axi_s2mm_aclk] [get_bd_pins multiply_dma/s_axi_lite_aclk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins old_add/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins const_multiply/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins const_multiply/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  ...
  # Create port connections
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins const_multiply/axi_resetn] [get_bd_pins old_add/ap_rst_n] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins const_multiply/s_axi_lite_aclk] [get_bd_pins old_add/ap_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs const_multiply/multiply/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs const_multiply/multiply_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs old_add/s_axi_control/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces const_multiply/multiply_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces const_multiply/multiply_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces const_multiply/multiply_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces const_multiply/multiply_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces const_multiply/multiply_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces const_multiply/multiply_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
...
file copy -force $proj_name.runs/impl_1/$proj_name\_wrapper.bit $overlay_path/$proj_name.bit
file copy -force $proj_name.gen/sources_1/bd/$proj_name/hw_handoff/$proj_name.hwh $overlay_path/$proj_name.hwh
file copy -force $proj_name.gen/sources_1/bd/$proj_name/hw_handoff/$proj_name\_bd.tcl $overlay_path/$proj_name.tcl
close_project
exit
